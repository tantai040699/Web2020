...
class ProductController extends Controller
{
    ...
    public function add_product(){
        $this -> Authlogin();
        $cate_product = DB::table('tbl_categogy_product')-> orderby('category_id','desc')->get();
    ...
    public function show_product_details($product_id)
    {
        ...
        -> join('tbl_categogy_product','tbl_categogy_product.category_id','=','tbl_product.category_id') 
        -> join('tbl_brand','tbl_brand.brand_id','=','tbl_product.brand_id') 
        -> where('tbl_categogy_product.category_id',$category_id)->whereNotIn('tbl_product.product_id',[$product_id])->get();
            
        return view('pages.product.show_product_detail')->with('category',$cate_product) ->with('brand',$brand_product)->with('product_detail',$detail_product)->with('related_product',$related_product);
    }
}